...
function Footer() {
  return (
    <div class="max-w-screen-xl mx-auto px-4 p-5 bg-purple-50 dark:bg-gray-900 rounded">
     
    <div class="pt-8 flex max-w-xs mx-auto items-center justify-between">
      
        <a href="https://www.twitter.com/presh_pie" class="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200 hover:animate-bounce">
        ...
        <a href="https://www.github.com/preshpi" class="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200 hover:animate-bounce">
        ...
        <a href="https://www.linkedin.com/in/preshpi-22/" class="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200 hover:animate-bounce">
            <svg width="20" height="20" fill="currentColor" class="text-xl hover:text-gray-800 dark:hover:text-white transition-colors duration-200" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
